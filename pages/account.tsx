          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <div style={{ color: "white", fontSize: "16px" }}>
                <div className="mb-6">
                  <span className="mr-4">{user?.name || user?.username || 'Không tên'}</span>
                  <span className="mr-4">ID: {user?.uid || user?.id?.toString() || 'N/A'}</span>
                  <span className="mr-4">
                ...
                <div className="mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-white">{(user?.balance ?? 0).toLocaleString()} VND</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-700 p-4 rounded">
                    ...
                    <p>Số tiền tối thiểu: {user?.minimumBet ? user.minimumBet.toLocaleString() : '0'} VND</p>
                    <p>Nạp tiền tối thiểu: {user?.minimumDeposit ? user.minimumDeposit.toLocaleString() : '0'} VND</p>
                    <p>Rút tiền tối thiểu: {user?.minimumWithdraw ? user.minimumWithdraw.toLocaleString() : '0'} VND</p>
                  </div>
                </div>
              </div>
            </div>
