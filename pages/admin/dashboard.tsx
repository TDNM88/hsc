  ...
  const fetchUsersData = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setData((prev: any) => ({ ...prev, customers: usersData.users }))
      }
    } catch (error) {
  ...
  const fetchTransactionsData = async (type: "deposits" | "withdrawals") => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (type === "deposits") {
          setData((prev: any) => ({ ...prev, depositRequests: transactionsData.transactions }))
        } else {
          setData((prev: any) => ({ ...prev, withdrawalRequests: transactionsData.transactions }))
        }
      }
    } catch (error) {
